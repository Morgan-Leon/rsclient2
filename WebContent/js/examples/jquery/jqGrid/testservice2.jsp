	...
	public class MyService extends StoreService {
		...
		public void read(StoreData data, SelRs rsSr, String companyCode,
			...
			String sql = "SELECT"
	                ...
	                + "INPUT_NAME,NEW_FLAG,VALID_FLAG,KEY_CLASS,SET_FLAG,QC_TRACE_TYPE,GL_MP_FLAG,GRP_PM_FLAG,"
	                + "SELF_PM_FLAG,ADMEASURE_FLAG,DISPENSE_FLAG,UPDATE_FLAG,PDM_MATERIAL_FLAG,REPAIR_FLAG,NEW_OLD_FLAG,"
	                + "REPAIR_OP_FLAG,NEW_RATE,CHECK_ACCEPT_FLAG,CUSTOMER_SEARCH_FLAG"
					+ " FROM inv_master "
					+ " WHERE company_code = '"
					+ companyCode
			...
			while (rs != null && rs.next()) {
				...
				map.put("INPUT_NAME", rs.getString(71));
				map.put("NEW_FLAG", rs.getString(72));
				map.put("VALID_FLAG", rs.getString(73));
				map.put("KEY_CLASS", rs.getString(74));
				map.put("SET_FLAG", rs.getString(75));
				map.put("QC_TRACE_TYPE", rs.getString(76));
				map.put("GL_MP_FLAG", rs.getString(77));
				map.put("GRP_PM_FLAG", rs.getString(78));
				map.put("SELF_PM_FLAG", rs.getString(79));
				map.put("ADMEASURE_FLAG", rs.getString(80));
				map.put("DISPENSE_FLAG", rs.getString(81));
				map.put("UPDATE_FLAG", rs.getString(82));
				map.put("PDM_MATERIAL_FLAG", rs.getString(83));
				map.put("REPAIR_FLAG", rs.getString(84));
				map.put("NEW_OLD_FLAG", rs.getString(85));
				map.put("REPAIR_OP_FLAG", rs.getString(86));
				map.put("NEW_RATE", rs.getString(87));
				map.put("CHECK_ACCEPT_FLAG", rs.getString(88));
				map.put("CUSTOMER_SEARCH_FLAG", rs.getString(89));
