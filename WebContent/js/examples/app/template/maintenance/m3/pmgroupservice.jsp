	...
	public class MyService extends StoreService {
		...
		public void read(StoreData data, SelRs rsSr, String companyCode,
			...
			String sql = "select group_id, group_name" 
                + " from pm_group_user where company_code='" 
                + companyCode + "' and user_unique_id = '" + userId + "'";
			
            String sqlSum = "select count(*) from pm_group_user where company_code='" 
                + companyCode + "' and user_unique_id = '" + userId + "'";
			...
			while (rs != null && rs.next()) {
				...
				map.put("group_id",rs.getString(1));
				map.put("group_name",rs.getString(2));
