Rs.define('rs.app.template.maintenance.TreeSearching', { 
        /**
         * @class TreeSearching
     ...
     * @param {Object} config
     */
Rs.define('rs.app.template.maintenance.DimTree', {
    ...
    constructor : function(config){
        ...
        rs.app.template.maintenance.DimTree.superclass.constructor.call(this, Rs.apply(config || {}, {
            useArrows : true,
            ...
            plugins : new rs.app.template.maintenance.TreeSearching({}),
