Rs.define('rs.demo.grid.BufferGrid', {
    ...
    constructor : function(config){
        var store = new Rs.ext.data.Store({
            autoLoad : true,
            autoDestroy: true,
            url: '/rsc/js/examples/app/demo/grid/bufferGrid/dataservice.rsc',
            root: 'items',
            idProperty: 'code',
            sortField : 'code',
        ...
        config = Rs.apply(config || {}, {
            ...
            view: new Rs.ext.grid.BufferView({
                rowHeight : 20,
                scrollDelay : true
            })
        });
        rs.demo.grid.BufferGrid.superclass.constructor.call(this, config);
    }
});