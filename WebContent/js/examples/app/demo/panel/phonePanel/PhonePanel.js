Rs.define('rs.demo.panel.PhonePanel', {
    ...
    constructor : function(config) {
        ...
        var store = this.store = new Ext.data.ArrayStore({
        ...
        var dataview = new Ext.DataView({
            ...
            tpl  : new Ext.XTemplate(
                '<ul>',
                    '<tpl for=".">',
                        '<li class="phone">',
                            '<img width="64" height="64" src="phonePanel/images/phones/{[values.name.replace(/ /g, "-")]}.png" />',
                            '<strong>{name}</strong>',
        ...
        rs.demo.panel.PhonePanel.superclass.constructor.call(this, config);
        
        this.on('render', function(){
            this.filterData(phoneSlider);
        }, this, {
            delay : 200,
            single : true
        });
