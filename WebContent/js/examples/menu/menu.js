...
Rs.ux.Menu = Rs.extend(Rs.util.Observable, {
    ...
    constructor: function(elId, config) {
        ...
        Rs.ux.Menu.superclass.constructor.call(this, config);
    ...
    initMarkup: function(){
        this.container = this.el.wrap({cls: 'ux-menu-container', style: 'z-index: ' + --Rs.ux.Menu.zSeed});
    ...
    initEvents: function() {
        this.showTask = new Rs.util.DelayedTask(this.showMenu, this);
        this.hideTask = new Rs.util.DelayedTask(function() {
        ...
        this.el.on('mouseover', function(ev, t) {
            ...
            if(!Rs.fly(t).hasClass('ux-menu-item-parent')) {
                this.showTask.cancel();
            }
        }, this, {delegate: 'li'});
    ...
    setCurrent: function() {
        ...
        var item = Rs.get(els[els.length-1]).removeClass(this.currentClass).findParent('li', null, true);
    ...
    doAutoWidth: function() {
        var fixWidth = function(sub) {
            ...
            widest = Rs.isIE ? widest + 1 : widest;
