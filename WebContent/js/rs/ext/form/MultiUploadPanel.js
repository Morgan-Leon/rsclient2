...
(function(){
	...
	Rs.ext.form.MultiUploadPanel = Ext.extend(Ext.Panel, {
		fileList : null,
		swfupload : null,
		progressBar : null,
		progressInfo : null,
		...
		constructor : function(config) {
			...
			Rs.ext.form.MultiUploadPanel.superclass.constructor.call(this, Ext.applyIf(config || {}, {
				layout : 'border',
				width : 500,
				height : 500,
				minWidth : 450,
		...
		onFileQueued : function(file) {
			...
			thiz.fileList.getStore().add(new Rs.ext.form.MultiUploadPanel.FileRecord({
				fileId : file.id,
				fileName : file.name,
				fileSize : file.size,
				fileType : file.type,
