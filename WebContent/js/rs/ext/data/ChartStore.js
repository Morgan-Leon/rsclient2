Rs.ext.data.ChartStore = Ext.extend(Ext.util.Observable, {
    writer : undefined,
    remoteSort : false,
    autoDestroy : false,
    ...
    constructor : function(config){
        ...
        Rs.ext.data.ChartStore.superclass.constructor.call(this);
    ...
    save : function() {
        if (!this.writer) {
            throw new Rs.ext.data.ChartStore.Error('writer-undefined');
        }
...
Ext.reg('store', Rs.ext.data.ChartStore);

/**
 * @class Rs.ext.data.ChartStore.Error
 * @extends Ext.Error
 * Store Error extension.
 * @param {String} name
 */
Rs.ext.data.ChartStore.Error = Ext.extend(Ext.Error, {
    name: 'Rs.ext.data.ChartStore'
});
Ext.apply(Rs.ext.data.ChartStore.Error.prototype, {
    lang: {
